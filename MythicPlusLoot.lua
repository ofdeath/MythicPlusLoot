...
function toggleFavItem(f, itemFrame, itemID)
	-- already added
	if itemFrame.favorite then
		undoFavItem(f, itemFrame, itemID);
	else
		redoFavItem(f, itemFrame, itemID);
	end
end

function changeFavRole(f, itemFrame, itemID)
...
function rotateFavorite(f, itemFrame, itemID)
	...
	if role == "" then
		...
		changeFavRole(f, itemFrame, itemID);
	end
end
...
function createFavItem(frame, itemFrame, itemID)
	...
	if tmpFavItems[itemID] ~= nil then
		rotateFavorite(itemFrame.fav, itemFrame, itemID);
		return
	end
		...
		if true then
			...
			function(self, button)
				...
				elseif button == "RightButton" then
					toggleFavItem(self, itemFrame, k);
				end
			end
			);
		end
